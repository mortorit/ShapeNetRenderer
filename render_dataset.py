...
def process_dataset(input_dataset_path, output_path, views, blender_executable, engine, categories, hide_output):
        ...
        if os.path.isdir(category_path):
            for sample_name in os.listdir(category_path):
                ...
                if os.path.exists(model_path):
                    ...
                    process_model(blender_executable, views, model_path, output_sample_path, engine, hide_output)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hide_output", type=lambda x: (str(x).lower() == 'true'), default=True, help="Hide output from Blender.")
    ...
    process_dataset(args.input_dataset_path, args.output_path, args.views, args.blender_path, args.engine,
                    args.categories, args.hide_output)
